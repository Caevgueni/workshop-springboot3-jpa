...
import com.devcarlos.course.entities.Payment;
...
import com.devcarlos.course.repositories.OrderItemRepository;
...
public class TestConfig implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		o1.setPayment(pay1);
		orderRepository.save(o1); // assim fazemos a insercao de associacao de um por um
